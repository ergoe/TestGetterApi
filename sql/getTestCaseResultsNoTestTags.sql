...
WHERE TestRun_id= @testRunId AND TestCaseExecution.CaseResult LIKE '%' + @testResult + '%' AND (TestCaseExecution.Description LIKE '%' OR TestCaseExecution.Description IS null)